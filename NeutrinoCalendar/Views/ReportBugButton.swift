...
/// report filed from inside Neutrino Calendar already knows which app it came from, so the central form's
...
enum BugReport {
    ...
    static let repository = "wcherry/neutrino_calendar_ios_mobile"
