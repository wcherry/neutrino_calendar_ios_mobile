#!/usr/bin/env bash
#
# Build, install, and launch Neutrino Calendar on an iOS Simulator or a real device.
#
...
readonly SCHEME="NeutrinoCalendar"
readonly PROJECT="NeutrinoCalendar.xcodeproj"
